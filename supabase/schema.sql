...
-- ============================================================================
-- 13. BELIEF GRAPH (Persistent cognitive model for Recursion)
-- ============================================================================
...
create index if not exists idx_belief_nodes_student_course on belief_nodes(student_id, course_id);
create index if not exists idx_belief_edges_course_from on belief_edges(course_id, from_concept);
create index if not exists idx_belief_edges_course_to on belief_edges(course_id, to_concept);
...
-- ============================================================================
-- 14. SESSION SUMMARIES (Lightweight session memory)
-- ============================================================================
